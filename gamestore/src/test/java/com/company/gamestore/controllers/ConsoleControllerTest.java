/***
 * The purpose of these controller tests are to make sure that:
 * 1. The controller correctly accepts and processes the incoming JSON request.
 * 2. The controller interacts as expected with the service layer.
 * 3. The controller responds with the correct HTTP status.
 */
...
public class ConsoleControllerTest {
    ...
    /**
     * We mock the ServiceLayer because the controller uses it.
     */
    @MockBean
